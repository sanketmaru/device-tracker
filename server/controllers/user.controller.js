...
function create(req, res, next) {
  ...
  _user2.default.getByUsername(req.body.username).then(function (existingUser) {
    if (existingUser.length) {
      var err = new _APIError2.default('Username Exists', _httpStatus2.default.CONFLICT, true);
      next(err);
      return;
    }
